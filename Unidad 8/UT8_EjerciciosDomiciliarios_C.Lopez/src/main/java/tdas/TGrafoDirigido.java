...
public class TGrafoDirigido implements IGrafoDirigido {
    ...
    public boolean eliminarArista(Comparable nomVerticeOrigen, Comparable nomVerticeDestino) {
        if ((nomVerticeOrigen != null) && (nomVerticeDestino != null)) {
            TVertice vertOrigen = (TVertice) buscarVertice(nomVerticeOrigen);
            if (vertOrigen != null) {
    ...
    public boolean existeArista(Comparable etiquetaOrigen, Comparable etiquetaDestino) {
        ...
        if ((vertOrigen != null) && (vertDestino != null)) {
            return vertOrigen.buscarAdyacencia((TVertice) vertDestino) != null;
        }
        return false;
    }
    ...
    public boolean insertarArista(TArista arista) {
        ...
        if ((arista.getEtiquetaOrigen() != null) && (arista.getEtiquetaDestino() != null)) {
            TVertice vertOrigen = (TVertice) buscarVertice(arista.getEtiquetaOrigen());
            TVertice vertDestino = (TVertice) buscarVertice(arista.getEtiquetaDestino());
