...
public class main {
    public static void main (String [] args){
        ...
        for (TArista arista : grafoKruskal.getLasAristas()) {
            String aristaIda = arista.getEtiquetaOrigen() + "-" + arista.getEtiquetaDestino();
            String aristaVuelta  = arista.getEtiquetaDestino() + "-" + arista.getEtiquetaOrigen();

            if (!yaImpresas.contains(aristaIda) && !yaImpresas.contains(aristaVuelta)) {
                yaImpresas.add(aristaIda);
