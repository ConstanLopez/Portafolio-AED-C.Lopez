...
public interface IGrafoDirigido {
    ...
    Comparable obtenerExcentricidad(Comparable etiquetaVertice,Double [][] matriz);

    void ClasificarArcos(TVertice verticeOrigen,List<TArista> ArcosArbol, List<TArista> ArcosRetroceso, List<TArista> ArcosAvance, List<TArista> ArcosCruzados);
